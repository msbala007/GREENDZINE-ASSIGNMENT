...
import { COURSE_DATA, DELETE_DATA } from "../Query/GraphQl";

const Transition = React.forwardRef(function Transition(props, ref) {
  return <Slide direction="up" ref={ref} {...props} />;
});

export default function AlertDialogSlide({ id, Title }) {
  ...
  return (
    <div>
      ...
      <Dialog
        ...
        onClose={handleClose}
      >
        <DialogTitle> Do you want delete this COURSE</DialogTitle>
        <DialogContent>
          <DialogContentText className="font-bold  text-center">
            {Title}
          </DialogContentText>
        </DialogContent>
        <DialogActions>
